...
# Scrapy settings for Torantula project

BOT_NAME = 'Torantula'

SPIDER_MODULES = ['Torantula.spiders']
NEWSPIDER_MODULE = 'Torantula.spiders'
...
DOWNLOADER_MIDDLEWARES = {
    'Torantula.middlewares.IgnoreDomainMiddleware': 390,
    'Torantula.middlewares.RandomUserAgentMiddleware': 410,
    'Torantula.middlewares.ProxyMiddleware': 400,
    'scrapy.downloadermiddlewares.ajaxcrawl.AjaxCrawlMiddleware': 430
}

# Privoxy server is a SOCKS proxy (to talk to Tor) but acts as an HTTP proxy for Torantula.
